const BarLoader = () => {
	return (
		<div className="min-h-screen flex flex-col items-center justify-center bg-[#FAFAFA] font-ubuntu">
			{/* Logo with subtle pulse */}
			<img src="/l.png" alt="Logo" className="w-24 h-24 mb-2 object-contain " />

			<h1 className="text-xl font-ubuntu font-semibold text-gray-700 mb-4 tracking-wide">
				Unique Solutions
			</h1>
